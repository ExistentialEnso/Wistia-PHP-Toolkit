...
*
* Class to represent Wistia Projects, the primary way an account's medias are usually organized.
* Every media must belong to a project, though, at this time, there isn't a way to upload medias
* directly through the API. However, ->getUploaderCode() can be used to produce embeddable HTML/JavaScript
* that can be used to add an upload button to your site.
* However, $anonymousCanUpload must be true for this to work (since this doesn't use any sort of authentication.
*
  ...
  */
  public function save() {
    if($this->publicId != null) {
      ...
      $project = new Project($this->account, $response);
      return $project;
    }
  }
